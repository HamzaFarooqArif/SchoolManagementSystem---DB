...
namespace WebApplication1.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public List<ReportViewModels> getReportList()
        {
            ...
            ReportsList[6] = new ReportViewModels(9, "Course wise result report");
            ReportsList[7] = new ReportViewModels(10, "Batch wise result report");
            ReportsList[8] = new ReportViewModels(7, "Student Fee report");
            ReportsList[9] = new ReportViewModels(8, "Employee Salary report");
